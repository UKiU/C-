...
static const char qt_meta_stringdata_test2[] = {
    "test2\0\0int\0checked\0OneClicked(bool)\0"
};
...
void test2::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: { int _r = _t->OneClicked((*reinterpret_cast< bool(*)>(_a[1])));
...
const QMetaObjectExtraData test2::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject test2::staticMetaObject = {
    { &QMainWindow::staticMetaObject, qt_meta_stringdata_test2,
      qt_meta_data_test2, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &test2::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_test2))
